...
const Menu = () => {
	return (
		<div className='px-6 bg-[#111111] py-[72px] text-white flex flex-col justify-center items-center xl:flex-row xl:justify-between xl:px-[165px] xl:h-[761px]'>
			{/* Section header  */}
			<div className='flex flex-col justify-center items-center xl:items-start xl:-mt-40'>
				<PatternDevide />
			...
			{/* Menu Cards  */}
			<div className='mt-[64px] flex flex-col justify-center items-center md:w-[573px] xl:w-[540px]'>
